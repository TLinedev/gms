const ASSET_BASE = "https://cdn.jsdelivr.net/gh/tlinedev/gms@main/customamplerstuff/";
// Not Added Feature
...
function generateprofile(game) {
    ...
    let running = false;
    if (!selectedGame1) {
        fetch(ASSET_BASE + "assets/json/base.json").then((response) => response.json()).then((data) => {
    ...
    if (!selectedGame2) {
        fetch(ASSET_BASE + "assets/json/modded.json").then((response) => response.json()).then((data) => {
    ...
    if (!selectedGame3) {
        fetch(ASSET_BASE + "assets/json/assisted.json").then((response) => response.json()).then((data) => {
...
function generategames(path) {
    ...
    if (localStorage.getItem("customlaunchers")) {
        let gamepath;
        if (path === ASSET_BASE + "assets/json/base.json") {gamepath = "basegame"};
        if (path === ASSET_BASE + "assets/json/modded.json") {gamepath = "moddedgame"};
        if (path === ASSET_BASE + "assets/json/assisted.json") {gamepath = "assisted"};
    ...
    fetch(path).then((response) => response.json()).then((data) => {
        let gamepath;
        if (path === ASSET_BASE + "assets/json/base.json") {
        ...
        if (path === ASSET_BASE + "assets/json/modded.json") {
        ...
        if (path === ASSET_BASE + "assets/json/assisted.json") {
...
function generatelauncheroptions(path, game, gamepath) {
        ...
        gameoption.addEventListener("click", () => {
            ...
            if (path === ASSET_BASE + "assets/json/base.json") {selectedGame1 = JSON.stringify(game); localStorage.setItem("basegame", selectedGame1)};
            if (path === ASSET_BASE + "assets/json/modded.json") {selectedGame2 = JSON.stringify(game); localStorage.setItem("moddedgame", selectedGame2)};
            if (path === ASSET_BASE + "assets/json/assisted.json") {selectedGame3 = JSON.stringify(game); localStorage.setItem("assisted", selectedGame3)};
            dropdowntoggle();
        });
...
function generatemods() {
    fetch(ASSET_BASE + "assets/json/mods.json").then((response) => response.json()).then((data) => {
        data.forEach((mod) => {
...
function newinstallation(data) {
    ...
    fetch(ASSET_BASE + "assets/json/icons.json").then((response) => response.json()).then((newicons) => {
...
function generatelaunchers(path) {
    ...
    if (localStorage.getItem("launcherpresets") == "false") {
        let gamepath;
        if (path === ASSET_BASE + "assets/json/base.json") {gamepath = JSON.parse(localStorage.getItem("basegame"))};
        if (path === ASSET_BASE + "assets/json/modded.json") {gamepath = JSON.parse(localStorage.getItem("moddedgame"))};
        if (path === ASSET_BASE + "assets/json/assisted.json") {gamepath = JSON.parse(localStorage.getItem("assisted"))};
...
function generatefaqs() {
    fetch(ASSET_BASE + "assets/json/faqs.json").then((response) => response.json()).then((data) => {
        data.forEach((game) => {
...
function generatenotes() {
    fetch(ASSET_BASE + "assets/json/patchnotes.json").then((response) => response.json()).then((data) => {
        data.forEach((note) => {
            ...
            patchnoteimg.src = ASSET_BASE + "assets/images/" + note.icon;
...
let launcher = ASSET_BASE + "assets/json/base.json";
...
function webedition(){
    launcher = ASSET_BASE + "assets/json/base.json";
    localStorage.setItem("startupprofile", "1");
    resetTabSelected();
    generateprofile(1);
    generatelaunchers(launcher);
    document.getElementById('game-bg').style.backgroundImage = 'url(https://cdn.jsdelivr.net/gh/tlinedev/gms@main/customamplerstuff/assets/images/web-edition.jpg)';
    document.getElementById('game-title').src = ASSET_BASE + 'assets/images/web-title.png';
...
function moddededition(){
    launcher = ASSET_BASE + "assets/json/modded.json";
    localStorage.setItem("startupprofile", "2");
    resetTabSelected();
    generateprofile(2);
    generatelaunchers(launcher);
    document.getElementById('game-bg').style.backgroundImage = 'url(https://cdn.jsdelivr.net/gh/tlinedev/gms@main/customamplerstuff/assets/images/modded-edition.jpg)';
    document.getElementById('game-title').src = ASSET_BASE + 'assets/images/modded-title.png';
...
function eaglercontrols(){
    launcher = ASSET_BASE + "assets/json/assisted.json";
    localStorage.setItem("startupprofile", "3");
    resetTabSelected();
    generateprofile(3);
    generatelaunchers(launcher);
    document.getElementById('game-bg').style.backgroundImage =  'url(https://cdn.jsdelivr.net/gh/tlinedev/gms@main/customamplerstuff/assets/images/controls-edition.jpg)';
    document.getElementById('game-title').src = ASSET_BASE + 'assets/images/controls-title.png';
...
function presetlaunchers() {
    if (presetscheckbox.checked) {
        localStorage.setItem("launcherpresets", true);
        fetch(ASSET_BASE + "assets/json/base.json").then((response) => response.json()).then((data) => {data.forEach((game) => {
            if (game.active == true) {localStorage.setItem(game.title, true)};
        })});
        fetch(ASSET_BASE + "assets/json/modded.json").then((response) => response.json()).then((data) => {data.forEach((game) => {
            if (game.active == true) {localStorage.setItem(game.title, true)};
        })});
        fetch(ASSET_BASE + "assets/json/assisted.json").then((response) => response.json()).then((data) => {data.forEach((game) => {
            if (game.active == true) {localStorage.setItem(game.title, true)};
        })});
        return
    }
